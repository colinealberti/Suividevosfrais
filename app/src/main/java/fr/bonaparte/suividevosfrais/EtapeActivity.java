...
public class EtapeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Global.changeAfficheDate((DatePicker) findViewById(R.id.datFrais), false) ;
        ...
        cmdMoins_clic() ;
        dat_clic() ;
        saisi = findViewById(R.id.txtEtape);
        disable(saisi);
    }
    ...
    private void valoriseProprietes() {
        annee = ((DatePicker)findViewById(R.id.datFrais)).getYear() ;
        mois = ((DatePicker)findViewById(R.id.datFrais)).getMonth() + 1 ;
    ...
    private void dat_clic() {
        final DatePicker uneDate = (DatePicker) findViewById(R.id.datFrais);
